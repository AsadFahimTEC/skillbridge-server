...
router4.get("/categories", auth_default("ADMIN" /* ADMIN */), async (req, res) => {
...
router6.post("/sign-up/email", authController.register);
router6.post("/sign-in/email", authController.login);
router6.get("/me", authController.getMe);
